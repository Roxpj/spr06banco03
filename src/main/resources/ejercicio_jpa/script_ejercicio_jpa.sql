...
CREATE TABLE `clientes` (
  ...
  CONSTRAINT `fk_clientes_personas` FOREIGN KEY (`idPersona`) REFERENCES `personas` (`idPersona`)
...
CREATE TABLE `clientes_productos` (
  ...
  CONSTRAINT `FK_fo288cseoqwqdivy6n0h0n9qa` FOREIGN KEY (`idCliente`) REFERENCES `clientes` (`idPersona`),
